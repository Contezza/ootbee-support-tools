 ...
 *
 */
package org.orderofthebee.addons.support.tools.repo.jscript.workflow;
...
@ScriptClass(types=ScriptClassType.JavaScriptRootObject, code="workflowAdmin",
             help="the root object for the de.jgoldhammer.alfresco.jscript.workflow interpreter used in the workflowconsole. "
